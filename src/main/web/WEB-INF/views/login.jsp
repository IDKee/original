...
<html>
	<head>
		...
		<link rel="stylesheet" href="${basePath}static/plugins/login/css/login.css" media="all"/>
		<style>
			/* 覆盖原框架样式 */
	...
	<body>
		...
		<div class="layui-fluid">
			<div class="layui-row layui-col-space15">
				<div class="layui-col-sm12 layui-col-md12 zyl_mar_01">
					<blockquote class="layui-elem-quote">简约后台登陆界面</blockquote>
				</div>
			</div>
		</div>
		<!-- Head End -->
			...
			<div class="layui-col-sm12 layui-col-md12">
				<div class="layui-carousel zyl_login_height" id="zyllogin" lay-filter="zyllogin">
					<div carousel-item="">
						...
						<div>
							<img src="${basePath}static/plugins/login/img/carousel/01.jpg" />
						</div>
						<div>
						...
						<div>
							<img src="${basePath}static/plugins/login/img/carousel/03.jpg" />
						</div>
					</div>
				</div>
			</div>
		...
		<div class="zyl_lofo_main">
			<fieldset class="layui-elem-field layui-field-title zyl_mar_02">
				<legend>欢迎登陆 - ORIGINAL管理平台</legend>
			</fieldset>
			<div class="layui-row layui-col-space15">
		...
		<!-- Jquery Js -->
		<script type="text/javascript" src="${basePath}static/plugins/login/js/jquery.min.js"></script>
		<!-- Jqarticle Js -->
		<script type="text/javascript" src="${basePath}static/plugins/login/assembly/jqarticle/jparticle.min.js"></script>
		<!-- ZylVerificationCode Js-->
		<script type="text/javascript" src="${basePath}static/plugins/login/assembly/zylVerificationCode/zylVerificationCode.js"></script>
		<script>
